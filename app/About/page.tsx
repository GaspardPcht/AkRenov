...
export default function About() {
  return (
    <div className="">
      <div className="flex justify-center text-2xl md:text-3xl font-bold mb-20 text-black">
        <h1>QUI SOMMES-NOUS ?</h1>
      </div>

      {/* Image Section */}
      <div className="flex justify-center lg:justify-normal mb-6 p-5  relative  ">
        <Image
          src="/assets/piscine.png"
          alt="Piscine rénovée par Akrénov"
          className='lg:w-[30%] rounded-lg mx-40'
          width={500}  // Ajuste la largeur selon ton image
          height={300} // Ajuste la hauteur selon ton image
        />

        {/* Text container */}
        <div className="hidden absolute lg:flex mt-4 lg:mt-0 bottom-9 lg:w-3/5 left-40">
          <ContainerText
            text={
      ...
      <div className="flex justify-center lg:justify-end mb-6 relative lg:right-36 mt-10 lg:mt-36 ">
        <Image
        ...
        {/* Text container */}
        <div className="hidden absolute lg:flex mt-4 lg:mt-0 bottom-9 right-32">
          <ContainerText
            text={
              <div>
      ...
      <div className="flex justify-center lg:justify-normal mt-4 mb-6 lg:mt-36 relative  ">
        <Image
          ...
          width={600}  // Ajuste la largeur selon ton image
          height={400} // Ajuste la hauteur selon ton image
        />

        {/* Text container */}
        <div className="hidden absolute lg:flex mt-4 lg:mt-0 bottom-9 left-1">
          <ContainerText
            text={
              <p>Akrénov, spécialiste de la rénovation en Bretagne. Une construction, un agrandissement de votre espace de vie, une rénovation de maison ou d’appartement, un aménagement de vos espaces extérieurs (création d’une terrasse en bois, porte de garage, pose d’un portail ou d’une clôture de parcelle…). Pour tous les chantiers intérieurs et extérieurs, l’entreprise assure la bonne gestion de vos chantiers. Akrénov, spécialistes du sur-mesure et de la construction, nous avons fait de la rénovation maison notre expertise. Maîtres d’oeuvre et d’ouvrage, notre équipe bretonne mène à bien des chantiers de construction.</p>
            }
