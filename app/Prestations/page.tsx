  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4 py-4">
        <CardsForPresta imageSrc="/icons/Maçonnerie.png" text="Maçonnerie" />
        <CardsForPresta imageSrc="/icons/charpente.png" text="Charpente" />
        <CardsForPresta imageSrc="/icons/placo.png" text="Cloison sèches" />
        <CardsForPresta imageSrc="/icons/menuiserie.png" text="Menuiserie" />
        <CardsForPresta
          imageSrc="/icons/carrelage.png"
          text="Aménagement Interieure"
        />
        <CardsForPresta imageSrc="/icons/terrasses.png" text="Exterieur" />
      </div>
